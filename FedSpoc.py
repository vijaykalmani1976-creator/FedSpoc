...
Original file is located at
    https://colab.research.google.com/gist/vijaykalmani1976-creator/250c49926b92d349fe4fe0b812e6fa38/newfedspoc500.ipynb
"""

!pip install -q flwr[simulation] stable-baselines3 gymnasium scikit-learn pandas numpy matplotlib seaborn ray[tune] tqdm

!pip install protobuf==5.29.3

!pip install grpcio==1.70.0 grpcio-health-checking==1.70.0
...
CHECKPOINT_DIR = "/content/drive/MyDrive/veeral_project/for_fedsptoc250/checkpoints"
OUTPUT_DIR = "/content/drive/MyDrive/veeral_project/for_fedsptoc250/results"
os.makedirs(CHECKPOINT_DIR, exist_ok=True)
os.makedirs(OUTPUT_DIR, exist_ok=True)

# Path to pickles / parquet (update if needed)
PKL_DIR = "/content/drive/MyDrive/veeral_project/for_fedsptoc250"
PKL_PATHS = {
